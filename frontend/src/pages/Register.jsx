      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-xl overflow-hidden relative z-10">
        <div className="p-8">
          <div className="flex flex-col items-center justify-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Start metering your APIs with MeterFlow</p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <input
                  ...
                  required
                />
                <User size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-blue-500 transition-colors" />
              </div>
            </div>
          ...
          <p className="text-center text-slate-400 text-sm mt-8">
            ...
            <Link to="/login" className="text-blue-500 hover:text-blue-400 font-medium transition-colors ml-1">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
